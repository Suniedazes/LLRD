...
export async function POST(request:Request){
 ...
 return reply("Your inquiry has not been sent. Online delivery is currently unavailable. Your entries are still here so you can copy them and try again later.",503);
}
