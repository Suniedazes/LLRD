...
export default async function sitemap():Promise<MetadataRoute.Sitemap>{
 const routes=["","/products","/updates","/about","/impact","/support","/privacy","/security","/legal","/terms","/cookies","/ai-policy","/accessibility","/state-privacy-rights","/family-privacy","/contact"];
